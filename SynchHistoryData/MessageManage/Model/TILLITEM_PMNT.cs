...
namespace ConsumerWorkerService.MessageManage.Model
{
    ...
    /// 
    /// </summary>
    public class TILLITEM_PMNT
    {
        /// <summary>
        /// 
        /// </summary>
        public TILLITEM_PMNT()
        {
        }
    ...
    public class bos_payment
    {
        ...
        /// 数据插入时间
        /// </summary>
        public System.DateTime? RECEIVEDATE { get { return this._RECEIVEDATE; } set { this._RECEIVEDATE = value; } }
    }
}
