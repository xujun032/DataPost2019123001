        ...
        public static void Subsribe()
        {
            Task.Run(() =>
            {
                ...
                var fanoutrg = new MesArgs()
                {
                    ...
                    routeName= "ConsumerWorkerService.ResParameter, ConsumerWorkerService_Site2HOSMessage",
                    rabbitQueeName = "ConsumerWorkerService.ResParameter, ConsumerWorkerService_Site2HOSMessage"
                };
