...
namespace Common.RabbitMQ
{
    internal class SendMessageMange : ISend
    {
        ...
        public void SendMsg(PushMsg pushMsg, IBus bus,string QueueName,string sendmsg)
        {
            ...
            bus.Send<string>(QueueName, sendmsg);
            // bus.Advanced.Publish(ex, pushMsg.routeName, false,message);
        }


        public void SendMsgByQueues(string  pushMsg, IBus bus, string QueuesName )
        {
            bus.Send<string>(pushMsg, QueuesName);
        }
